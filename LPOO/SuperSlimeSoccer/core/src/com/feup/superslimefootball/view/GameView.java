...
public class GameView extends ScreenAdapter {
    ...
    private void updateScore(){
        ...
        (GameConfig.getInstance().getGoalLimit().intValue() == GameModel.getInstance().getScore().getPlayer2().intValue() && NetworkManager.getInstance().isConnected() && !NetworkManager.getInstance().isServer())) {
            ...
            game.setScreen(new MenuView(game));
                ...
                (GameConfig.getInstance().getGoalLimit().intValue() == GameModel.getInstance().getScore().getPlayer1().intValue() && NetworkManager.getInstance().isConnected() && !NetworkManager.getInstance().isServer())){
