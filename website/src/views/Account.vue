...
export default Vue.extend({
  ...
  methods: {
    register: function() {
        this.onFormSubmit(this.credentials);
    }
  },
  props: {
    credentials: Object,
  ...
  <div class="w-50 mx-auto mb-5">
    <div class="mt-5 d-flex flex-column mx-auto p-4 bg-light" id="register">
      <fieldset class="d-flex flex-column mx-0">
          ...
          <h1 class="mx-auto pt-3 mb-5 font-weight-bold"> {{ title }}</h1>
          ...
          <button class="btn btn-primary mx-auto w-50 mb-3 mt-4" @click="register" v-bind:disabled="hasErrors">{{ buttonText }}</button>
        </fieldset>
    </div>
  </div> 
