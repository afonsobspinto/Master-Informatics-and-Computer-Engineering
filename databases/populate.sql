...
INSERT INTO "public"."categories" ("id","name") VALUES (1,'mE2j0rkp7DHY3i47jCtmXs1o');
 
 
INSERT INTO "public"."categories" ("id","name") VALUES (2,NULL);
 
 
INSERT INTO "public"."categories" ("id","name") VALUES (3,'h8Fpi80yKkrtZXXazmm3xiFOVcyl4bUGAZk');
 
 
INSERT INTO "public"."categories" ("id","name") VALUES (4,'5yOECwAD3iXtgKtkjKZG5xVNr5k0');
 
 
INSERT INTO "public"."categories" ("id","name") VALUES (5,'mboqS');
 
 
INSERT INTO "public"."categories" ("id","name") VALUES (6,'ZJvromwckSamMDUVIl5v48');
 
 
INSERT INTO "public"."categories" ("id","name") VALUES (7,'51gO3Reap4');
 
 
INSERT INTO "public"."categories" ("id","name") VALUES (8,NULL);
 
 
INSERT INTO "public"."categories" ("id","name") VALUES (9,'OFre4');
 
 
INSERT INTO "public"."categories" ("id","name") VALUES (10,'fsD8WWVwRHBqkiZ');
...
INSERT INTO "public"."messages" ("id","subject","message","send_date") VALUES (1,'czGzXwEEjqjx6gyk1YnaVAQw1Ds5j4NfynInIyrTGZeBimKeWzrU4Iy4YD0IYEUfID5An2WMYmebnw1xsQCc7YUv1BKbX0OiddibtqJQNZdUEluZWR5QEBK7ArRed1o8XS','Qj8aixfPmTeMcNnAN1','11/26/2000 10:21:00');
...
INSERT INTO "public"."messages" ("id","subject","message","send_date") VALUES (10,'cJffKxYJ7WVl2OTjR3sZ1VXEeWBW0O6fm7qqPU2N6TzHsSheBxRmvCvOW2s6VjGjDqCq4R2LQBFbyQzG0aUbBFPYFZOrSBnugUoGqVshm7SyVvlPMZNnZnkkl5mWOLBt145TibQ8CLV7yFkYjqedVWbS6U2kWW3XWgaqHSgkg7WLzmCR7PeOSPH7qJ1lGldygouHidizzJUPnJCLoG2g866FDB3JpYFaN5','ywlD5byLg0nJVjs3eZs5GNzjdTsGQuP3Cw','08/24/2007 02:48:00');
...
INSERT INTO "public"."users" ("id","username","first_name","last_name","password","email","zip_code","address","registration_date","profile_picture_path","location","rating","is_administrator") VALUES (1,'Frederik804','Ross',NULL,'BSS8Q1EBkaFYrQdhWOtudgYeVTeFpWW1qnfPhaD','E.Young@libero.cn','94167','31 Stewart Ave','04/04/2011 06:48:00','C:\DOCS\DATA46',1,1.58,True);
 
 
INSERT INTO "public"."users" ("id","username","first_name","last_name","password","email","zip_code","address","registration_date","profile_picture_path","location","rating","is_administrator") VALUES (2,'Mads9','Marie','Katsekes','KoXWfF0CzM6UzCuKOA8p8GbH','Mick.Byrnes5@telfort.cc','42767','8 Brooke Valley Drive','06/25/2013 03:26:00','C:\PROGRAM FILES\TEMP98', 1,1.1,True);
 

INSERT INTO "public"."users" ("id","username","first_name","last_name","password","email","zip_code","address","registration_date","profile_picture_path","location","rating","is_administrator") VALUES (3,'Richard889',NULL,'Morton','h2CwXXCEBU8KHcBrnsf0DvPLRwCqkuqGQGQrKZczLwmTG','Dave.Petterson@dolfijn.dk','84063',NULL,NULL,'C:\DOCUMENTS\TEMP26', 1,4.01,True);

 
INSERT INTO "public"."users" ("id","username","first_name","last_name","password","email","zip_code","address","registration_date","profile_picture_path","location","rating","is_administrator") VALUES (4,'Dave3','Isabel','Bloom','uIzryBfxvW0I4QGAZjU3Qba5tx5JLa','JohanDepew@libero.be','39927','4235 Serang Place','12/04/2006 00:22:00','pathy', 2,3.73,True);
 
 
INSERT INTO "public"."users" ("id","username","first_name","last_name","password","email","zip_code","address","registration_date","profile_picture_path","location","rating","is_administrator") VALUES (5,'Magnus420','Olivia','Stewart','wgD3eJPKOWH4B6fev32IW2q1gWTckCT0YCzug3','E.King3@dolfijn.fr','73108','20 Devonshire Rd','12/06/2016 06:23:00','C:\TEMPORARY\DATA76', 2,3.21,False);
 
 
INSERT INTO "public"."users" ("id","username","first_name","last_name","password","email","zip_code","address","registration_date","profile_picture_path","location","rating","is_administrator") VALUES (6,'Sophia812','Olivia','Swaine','btF7nhhTFQ47Ky6UfGaOqsIIFe','YLamere@excite.us',NULL,'0 Melrose Ave',NULL,'C:\TEMP\DOCS03', 3,1.22,NULL);
 
 
INSERT INTO "public"."users" ("id","username","first_name","last_name","password","email","zip_code","address","registration_date","profile_picture_path","location","rating","is_administrator") VALUES (7,'Tim16',NULL,'Bernstein','AntqmXxP126y7GdcM','Trees.King@hotmail.gov','94588','991 East MacArthur','11/29/2006 04:42:00','C:\TEMPORARY\DOC87', 3,4.91,True);
 
 
INSERT INTO "public"."users" ("id","username","first_name","last_name","password","email","zip_code","address","registration_date","profile_picture_path","location","rating","is_administrator") VALUES (8,'Louise00','Cloe','Nahay','AVICgUWfmHgEI0z8Yj0UBsFtieg8qya5ZL1rwAulDrlcQsQzm','LindsyBrown@weboffice.no','71654','2024 Melrose Ave','11/30/2011 01:07:00','C:\TEMP\TEMP57', 3,3.48,False);
 
 
INSERT INTO "public"."users" ("id","username","first_name","last_name","password","email","zip_code","address","registration_date","profile_picture_path","location","rating","is_administrator") VALUES (9,'Henk241','Oscar','Poissant','6deWU7sUNR','E.Cramer@dolfijn.us',NULL,'8 N. Jackson Road','08/09/2003 10:01:00','C:\DATA\DOCS91', 4,2.21,NULL);
 
 
INSERT INTO "public"."users" ("id","username","first_name","last_name","password","email","zip_code","address","registration_date","profile_picture_path","location","rating","is_administrator") VALUES (10,NULL,'Peggy',NULL,'6BbknOftvtVyJWWCNu3zMCQY1ORPcfiT7IvJrFW75vzcY','JohanTudisco5@dolfijn.com',NULL,'0 W. Broadway','01/29/2014 04:25:00','dwad', 5,1.78,False);
...
INSERT INTO "public"."auctions" ("id","item_name","description","starting_price","current_price","condition","publication_date","end_date","payment_type","shipping_options","shipping_cost","images_folder","owner_id","category_id","city_id","search") VALUES (1,'Lv5QAwM3aBBQ70mN0DgN8J1EH06AA7c6F6vbwMygPV575I1DwXlRU6oduc1bHOP8Iw7mdHv8HhDsgq55YrCHTRkr3CdUBT0lCi5uOcw0bPdEhtr8JiqeaTZtXkfawXTdpvjUK8tXAgcpovMGmpdItYPUxoIny',NULL,8049.15,NULL,'Used','01/07/2000 00:50:00','01/21/2012 04:30:00','PayPal','No shipping',494.59,'C:\DATA\DOCS98',1, 1,1,'3AuhETChCHqwAeAx0ohvhEqVsnWKGBUyoR2jnJrZ6mdgPh2Fw3xSM5rXr5CUyTrD8Iadi4MkZTfvtAtZMj1vIkZuKN1ZVEda6JIQmWgJk');
 
 
INSERT INTO "public"."auctions" ("id","item_name","description","starting_price","current_price","condition","publication_date","end_date","payment_type","shipping_options","shipping_cost","images_folder","owner_id","category_id","city_id","search") VALUES (2,'aWpjpRqelVcL7MdJ12vjtDPfFABtL0p0Vl6cBo8oaSCoJtArjCkbGhTUH2HbNfXkqeCmCgP0IonNPJwunDBxYAZ4o7kGxDVluqGO6fYGdtr84','This is a description 5384726',4337.40,35.21,'Used','11/07/2007 04:32:00','04/12/2012 05:08:00','PayPal','No shipping',4.63,NULL, 1, 2,2,'rCsPR7Vab6e1KyVPFV60im3UTcE3cMe8WfC0Lh7SGsVefcgSIDuI6i2wXKhMkcWoNEXLEHNWhSEUCLnKchNJvNrnEkkDIKmO1XH3G28Bo4CLPqEVs');
 
 
INSERT INTO "public"."auctions" ("id","item_name","description","starting_price","current_price","condition","publication_date","end_date","payment_type","shipping_options","shipping_cost","images_folder","owner_id","category_id","city_id","search") VALUES (3,'OuRRXvuAXCY8uokM8C2OsamXVJaj350Iji1XqCPhi177P3Mc3SxCCjXsBrC32FUAE0iXHAHIx25brM23dppbii','This is a description 1341487',2866.59,5221.08,'Used','03/19/2001 10:06:00','11/15/2005 10:34:00','PayPal','No shipping',269.93,'C:\APPDATA\DOC81', 2, 2,3,'ryKAl0611N2KczhccdmIug6CNtGRT06hjjy1eVEUZrdQvzJ7ZTGeZWr4hqNhhbQJGMRl5G7yUCeHDZyOwV2fGxV0mBg2vwxgoEw8nBpjLemw2XsgCnmqcZn8x20UQgLEWOKsUijKvpZHoOBIUxvEwtDFW566lEKcnzxho7i40GHYYv0nXQKB');
 
 
INSERT INTO "public"."auctions" ("id","item_name","description","starting_price","current_price","condition","publication_date","end_date","payment_type","shipping_options","shipping_cost","images_folder","owner_id","category_id","city_id","search") VALUES (4,'cC5rBCtWsr4X1N7lif2sQQZDnrn5Tg7tAmeDxz5yThUjpLaAigPStUuSdNOHYObt4wthMAwO6DdTkavhNeHAh54XSGBQ1P4h31kE6zXWpYFWo3aJf5XWmkxgcX7ZqLGmQ1uMEPUwTQlFsPFSS7DUiDW7eWIS1xpDXAa7a2GbjekuWJl','Description number 7219436',0.85,NULL,'Used','05/07/2002 08:47:00','08/20/2010 10:51:00','PayPal','No shipping',95704.75,'C:\DOCUMENTS\DOCS28', 3, 1,1,NULL);
 
 
INSERT INTO "public"."auctions" ("id","item_name","description","starting_price","current_price","condition","publication_date","end_date","payment_type","shipping_options","shipping_cost","images_folder","owner_id","category_id","city_id","search") VALUES (5,'MddSsCpo13VJp8HBxqlwSTwzO','Description number 8637276',6.37,6155.35,'Used','11/20/2003 01:06:00','06/04/2007 03:07:00','PayPal','No shipping',NULL,NULL, 2, 5,2,NULL);
 
 
INSERT INTO "public"."auctions" ("id","item_name","description","starting_price","current_price","condition","publication_date","end_date","payment_type","shipping_options","shipping_cost","images_folder","owner_id","category_id","city_id","search") VALUES (6,'Zo2lhsYyEMylLoYwhrtspCAkN5GSDNbAFZW5yylNX1FUnAJ54LVq8mIii5aKJqa6hfpt68FDkBfygZeaAE666lIMZ7XGQwjOQjzFTD8j1oeOywGOQbiibWJjOJF3ybiwo7hbh1It5dVByUMwFqXcQrCHqJRdfhn6cViVYKsMQjF5K8tnOjxjyQk4ynnOHm5edPpuWkY43RscZCySIWhksrmcmp7fKxB3MSW','This is a description 8815846',37502.85,5.71,'Used',NULL,'11/16/2006 10:07:00','PayPal','No shipping',0.15,'C:\TEMPORARY\DATA22', 4, 3,3,'Yz');
 



 
INSERT INTO "public"."bids" ("id","bidder_id","bid_amount") VALUES (1 ,6,763895);
 
 
INSERT INTO "public"."bids" ("id","bidder_id","bid_amount") VALUES (2,7,353202);
 
 
INSERT INTO "public"."bids" ("id","bidder_id","bid_amount") VALUES (3,8,842809);



 
INSERT INTO "public"."reviews" ("id","rating","description") VALUES (5,642350,'Description number 3028653');
 
 
INSERT INTO "public"."reviews" ("id","rating","description") VALUES (6,688953,'Description number 3261390');
 
 
INSERT INTO "public"."reviews" ("id","rating","description") VALUES (1,901247,'This is a description 7010386');
...
INSERT INTO "public"."won_auctions" ("id","is_successful_transaction","has_winner_complained","winner_id") VALUES (5,True,True,2);
