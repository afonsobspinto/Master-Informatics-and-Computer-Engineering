...
public abstract class Guard  extends Character{
	...
	public Guard(int level){
		...
		switch (level) {
		case 0: startingPos = new Coord(1,3); this.position = startingPos; this.route = new Coord[1]; this.route[0]=startingPos;
			this.route_dir = new Direction[1]; this.route_dir[0]=Direction.LEFT; this.orientation = Direction.LEFT; break;
		case 1: startingPos = new Coord(1,8); this.position = startingPos; this.route = new Coord[1]; 	this.route[0]=startingPos;
			this.route_dir = new Direction[1]; this.route_dir[0]=Direction.LEFT; this.orientation = Direction.LEFT; break;
		case 2: startingPos = new Coord(1,8); this.position = startingPos; Coord[] temp = { 
			...
			this.orientation = route_dir[0]; break; default: break; }
	}
