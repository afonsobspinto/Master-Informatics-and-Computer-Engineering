...
sleep 1
konsole -title testApp --noclose  -e java Client.TestApp //127.0.0.1/Peer1 BACKUP ../TestFiles/afonso.jpg 2 &
sleep 5
konsole -title testApp --noclose  -e java Client.TestApp //127.0.0.1/Peer1 RESTORE ../TestFiles/afonso.jpg
