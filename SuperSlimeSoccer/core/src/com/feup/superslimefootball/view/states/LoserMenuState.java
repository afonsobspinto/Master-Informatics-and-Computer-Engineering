...
public class LoserMenuState extends MenuState {
    ...
    public void drawButtons() {
        ...
        this.game.getBatch().draw(youlost, VIEWPORT_WIDTH*(3.0f/10.0f), VIEWPORT_HEIGHT*(14.0f/20.0f));
    ...
    public void handleMouse() {
        if(Gdx.input.justTouched()) {
            if (touchButton(1.0f / 13.0f, 17.0f / 20.0f, BUTTONS_WIDTH, BUTTONS_HEIGHT)){
                ...
                FacebookIntegration.getInstance().publish(false);
            }
        }
    }
}
