...
@section('content')
    <div class="container mt-4" id="auction-section">
        <div class="row">
            <div class="col-md-9">
                <div class="row">
                </div>
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <span class="display-4">Dell XPS 15</span>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="qa" role="tabpanel" aria-labelledby="qa-tab">
                <dl class="row">
                    ...
                    <dt class="col-sm-4 text-align-center mobile-text-center">Does it come with Linux?</dt>
                    <dd class="col-sm-8">
                                        ...
                                        <form>
                                            <div class="form-group">
                                                <div>
                                                    ...
                                                    <div class="radio">
                                                        <label><input type="radio" name="content">Inappropriate content in profile </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label><input type="radio"
